...
* [Introduction](https://laravel.com/docs/11.x/strings#introduction)
* [Available Methods](https://laravel.com/docs/11.x/strings#available-methods)

### [Introduction](https://laravel.com/docs/11.x/strings#introduction) <a href="#introduction" id="introduction"></a>
...
[**`class_basename()`**](https://laravel.com/docs/11.x/strings#method-class-basename)
...
[**`preg_replace_array()`**](https://laravel.com/docs/11.x/strings#method-preg-replace-array)
...
[**`Str::after()`**](https://laravel.com/docs/11.x/strings#method-str-after)
...
[**`Str::afterLast()`**](https://laravel.com/docs/11.x/strings#method-str-after-last)
...
[**`Str::apa()`**](https://laravel.com/docs/11.x/strings#method-str-apa)
...
[**`Str::ascii()`**](https://laravel.com/docs/11.x/strings#method-str-ascii)
...
[**`Str::before()`**](https://laravel.com/docs/11.x/strings#method-str-before)
...
[**`Str::beforeLast()`**](https://laravel.com/docs/11.x/strings#method-str-before-last)
...
[**`Str::between()`**](https://laravel.com/docs/11.x/strings#method-str-between)
...
[**`Str::betweenFirst()`**](https://laravel.com/docs/11.x/strings#method-str-between-first)
...
[**`Str::camel()`**](https://laravel.com/docs/11.x/strings#method-camel-case)
...
[**`Str::chopStart()`**](https://laravel.com/docs/11.x/strings#method-str-chop-start)
...
[**`Str::chopEnd()`**](https://laravel.com/docs/11.x/strings#method-str-chop-end)
...
[**`Str::contains()`**](https://laravel.com/docs/11.x/strings#method-str-contains)
...
[**`Str::containsAll()`**](https://laravel.com/docs/11.x/strings#method-str-contains-all)
...
[**`Str::doesntContain()`**](https://laravel.com/docs/11.x/strings#method-str-doesnt-contain)
...
[**`Str::finish()`**](https://laravel.com/docs/11.x/strings#method-str-finish)
...
[**`Str::headline()`**](https://laravel.com/docs/11.x/strings#method-str-headline)
...
[**`Str::inlineMarkdown()`**](https://laravel.com/docs/11.x/strings#method-str-inline-markdown)
...
[**`Str::is()`**](https://laravel.com/docs/11.x/strings#method-str-is)
...
[**`Str::isAscii()`**](https://laravel.com/docs/11.x/strings#method-str-is-ascii)
...
[**`Str::isJson()`**](https://laravel.com/docs/11.x/strings#method-str-is-json)
...
[**`Str::isUrl()`**](https://laravel.com/docs/11.x/strings#method-str-is-url)
...
[**`Str::isUlid()`**](https://laravel.com/docs/11.x/strings#method-str-is-ulid)
...
[**`Str::isUuid()`**](https://laravel.com/docs/11.x/strings#method-str-is-uuid)
...
[**`Str::kebab()`**](https://laravel.com/docs/11.x/strings#method-kebab-case)
...
[**`Str::lcfirst()`**](https://laravel.com/docs/11.x/strings#method-str-lcfirst)
...
[**`Str::length()`**](https://laravel.com/docs/11.x/strings#method-str-length)
...
[**`Str::limit()`**](https://laravel.com/docs/11.x/strings#method-str-limit)
...
[**`Str::lower()`**](https://laravel.com/docs/11.x/strings#method-str-lower)
...
[**`Str::markdown()`**](https://laravel.com/docs/11.x/strings#method-str-markdown)
...
[**`Str::mask()`**](https://laravel.com/docs/11.x/strings#method-str-mask)
...
[**`Str::orderedUuid()`**](https://laravel.com/docs/11.x/strings#method-str-ordered-uuid)
...
[**`Str::padBoth()`**](https://laravel.com/docs/11.x/strings#method-str-padboth)
...
[**`Str::padLeft()`**](https://laravel.com/docs/11.x/strings#method-str-padleft)
...
[**`Str::padRight()`**](https://laravel.com/docs/11.x/strings#method-str-padright)
...
[**`Str::password()`**](https://laravel.com/docs/11.x/strings#method-str-password)
...
[**`Str::plural()`**](https://laravel.com/docs/11.x/strings#method-str-plural)

The `Str::plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Laravel's pluralizer](https://laravel.com/docs/11.x/localization#pluralization-language):
...
[**`Str::pluralStudly()`**](https://laravel.com/docs/11.x/strings#method-str-plural-studly)

The `Str::pluralStudly` method converts a singular word string formatted in studly caps case to its plural form. This function supports [any of the languages support by Laravel's pluralizer](https://laravel.com/docs/11.x/localization#pluralization-language):
...
[**`Str::position()`**](https://laravel.com/docs/11.x/strings#method-str-position)
...
[**`Str::random()`**](https://laravel.com/docs/11.x/strings#method-str-random)
...
[**`Str::remove()`**](https://laravel.com/docs/11.x/strings#method-str-remove)
...
[**`Str::repeat()`**](https://laravel.com/docs/11.x/strings#method-str-repeat)
...
[**`Str::replace()`**](https://laravel.com/docs/11.x/strings#method-str-replace)
...
[**`Str::replaceArray()`**](https://laravel.com/docs/11.x/strings#method-str-replace-array)
...
[**`Str::replaceFirst()`**](https://laravel.com/docs/11.x/strings#method-str-replace-first)
...
[**`Str::replaceLast()`**](https://laravel.com/docs/11.x/strings#method-str-replace-last)
...
[**`Str::replaceMatches()`**](https://laravel.com/docs/11.x/strings#method-str-replace-matches)
...
[**`Str::replaceStart()`**](https://laravel.com/docs/11.x/strings#method-str-replace-start)
...
[**`Str::replaceEnd()`**](https://laravel.com/docs/11.x/strings#method-str-replace-end)
...
[**`Str::reverse()`**](https://laravel.com/docs/11.x/strings#method-str-reverse)
...
[**`Str::singular()`**](https://laravel.com/docs/11.x/strings#method-str-singular)

The `Str::singular` method converts a string to its singular form. This function supports [any of the languages support by Laravel's pluralizer](https://laravel.com/docs/11.x/localization#pluralization-language):

```
use Illuminate\Support\Str; $singular = Str::singular('cars'); // car $singular = Str::singular('children'); // child
```

[**`Str::slug()`**](https://laravel.com/docs/11.x/strings#method-str-slug)
...
[**`Str::snake()`**](https://laravel.com/docs/11.x/strings#method-snake-case)
...
[**`Str::squish()`**](https://laravel.com/docs/11.x/strings#method-str-squish)
...
[**`Str::start()`**](https://laravel.com/docs/11.x/strings#method-str-start)
...
[**`Str::studly()`**](https://laravel.com/docs/11.x/strings#method-studly-case)
...
[**`Str::substr()`**](https://laravel.com/docs/11.x/strings#method-str-substr)
...
[**`Str::substrCount()`**](https://laravel.com/docs/11.x/strings#method-str-substrcount)
...
[**`Str::substrReplace()`**](https://laravel.com/docs/11.x/strings#method-str-substrreplace)
...
[**`Str::swap()`**](https://laravel.com/docs/11.x/strings#method-str-swap)
...
[**`Str::title()`**](https://laravel.com/docs/11.x/strings#method-title-case)
...
[**`Str::toBase64()`**](https://laravel.com/docs/11.x/strings#method-str-to-base64)
...
[**`Str::transliterate()`**](https://laravel.com/docs/11.x/strings#method-str-transliterate)
...
[**`Str::trim()`**](https://laravel.com/docs/11.x/strings#method-str-trim)
...
[**`Str::ltrim()`**](https://laravel.com/docs/11.x/strings#method-str-ltrim)
...
[**`Str::rtrim()`**](https://laravel.com/docs/11.x/strings#method-str-rtrim)
...
[**`Str::ucfirst()`**](https://laravel.com/docs/11.x/strings#method-str-ucfirst)
...
[**`Str::ucsplit()`**](https://laravel.com/docs/11.x/strings#method-str-ucsplit)
...
[**`Str::upper()`**](https://laravel.com/docs/11.x/strings#method-str-upper)
...
[**`Str::ulid()`**](https://laravel.com/docs/11.x/strings#method-str-ulid)
...
[**`Str::unwrap()`**](https://laravel.com/docs/11.x/strings#method-str-unwrap)
...
[**`Str::uuid()`**](https://laravel.com/docs/11.x/strings#method-str-uuid)
...
[**`Str::wordCount()`**](https://laravel.com/docs/11.x/strings#method-str-word-count)
...
[**`Str::wordWrap()`**](https://laravel.com/docs/11.x/strings#method-str-word-wrap)
...
[**`Str::words()`**](https://laravel.com/docs/11.x/strings#method-str-words)
...
[**`Str::wrap()`**](https://laravel.com/docs/11.x/strings#method-str-wrap)
...
The `trans` function translates the given translation key using your [language files](https://laravel.com/docs/11.x/localization):
...
[**`trans_choice()`**](https://laravel.com/docs/11.x/strings#method-trans-choice)
...
### [Fluent Strings](https://laravel.com/docs/11.x/strings#fluent-strings) <a href="#fluent-strings" id="fluent-strings"></a>

Fluent strings provide a more fluent, object-oriented interface for working with string values, allowing you to chain multiple string operations together using a more readable syntax compared to traditional string operations.

[**`after`**](https://laravel.com/docs/11.x/strings#method-fluent-str-after)
...
[**`afterLast`**](https://laravel.com/docs/11.x/strings#method-fluent-str-after-last)
...
[**`apa`**](https://laravel.com/docs/11.x/strings#method-fluent-str-apa)
...
[**`append`**](https://laravel.com/docs/11.x/strings#method-fluent-str-append)
...
[**`ascii`**](https://laravel.com/docs/11.x/strings#method-fluent-str-ascii)
...
[**`basename`**](https://laravel.com/docs/11.x/strings#method-fluent-str-basename)
...
[**`before`**](https://laravel.com/docs/11.x/strings#method-fluent-str-before)
...
[**`beforeLast`**](https://laravel.com/docs/11.x/strings#method-fluent-str-before-last)
...
[**`between`**](https://laravel.com/docs/11.x/strings#method-fluent-str-between)
...
[**`betweenFirst`**](https://laravel.com/docs/11.x/strings#method-fluent-str-between-first)
...
[**`camel`**](https://laravel.com/docs/11.x/strings#method-fluent-str-camel)
...
[**`charAt`**](https://laravel.com/docs/11.x/strings#method-fluent-str-char-at)
...
[**`classBasename`**](https://laravel.com/docs/11.x/strings#method-fluent-str-class-basename)
...
[**`chopStart`**](https://laravel.com/docs/11.x/strings#method-fluent-str-chop-start)
...
[**`chopEnd`**](https://laravel.com/docs/11.x/strings#method-fluent-str-chop-end)
...
[**`contains`**](https://laravel.com/docs/11.x/strings#method-fluent-str-contains)
...
[**`containsAll`**](https://laravel.com/docs/11.x/strings#method-fluent-str-contains-all)
...
[**`deduplicate`**](https://laravel.com/docs/11.x/strings#method-fluent-str-deduplicate)
...
[**`dirname`**](https://laravel.com/docs/11.x/strings#method-fluent-str-dirname)
...
[**`endsWith`**](https://laravel.com/docs/11.x/strings#method-fluent-str-ends-with)
...
[**`exactly`**](https://laravel.com/docs/11.x/strings#method-fluent-str-exactly)
...
[**`excerpt`**](https://laravel.com/docs/11.x/strings#method-fluent-str-excerpt)
...
[**`explode`**](https://laravel.com/docs/11.x/strings#method-fluent-str-explode)
...
[**`finish`**](https://laravel.com/docs/11.x/strings#method-fluent-str-finish)
...
[**`headline`**](https://laravel.com/docs/11.x/strings#method-fluent-str-headline)
...
[**`inlineMarkdown`**](https://laravel.com/docs/11.x/strings#method-fluent-str-inline-markdown)
...
[**`is`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is)
...
[**`isAscii`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-ascii)
...
[**`isEmpty`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-empty)
...
[**`isNotEmpty`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-not-empty)
...
[**`isJson`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-json)
...
[**`isUlid`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-ulid)
...
[**`isUrl`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-url)
...
[**`isUuid`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-uuid)
...
[**`kebab`**](https://laravel.com/docs/11.x/strings#method-fluent-str-kebab)
...
[**`lcfirst`**](https://laravel.com/docs/11.x/strings#method-fluent-str-lcfirst)
...
[**`length`**](https://laravel.com/docs/11.x/strings#method-fluent-str-length)
...
[**`limit`**](https://laravel.com/docs/11.x/strings#method-fluent-str-limit)
...
[**`lower`**](https://laravel.com/docs/11.x/strings#method-fluent-str-lower)
...
[**`markdown`**](https://laravel.com/docs/11.x/strings#method-fluent-str-markdown)
...
[**`mask`**](https://laravel.com/docs/11.x/strings#method-fluent-str-mask)
...
[**`match`**](https://laravel.com/docs/11.x/strings#method-fluent-str-match)
...
[**`matchAll`**](https://laravel.com/docs/11.x/strings#method-fluent-str-match-all)
...
[**`isMatch`**](https://laravel.com/docs/11.x/strings#method-fluent-str-is-match)
...
[**`newLine`**](https://laravel.com/docs/11.x/strings#method-fluent-str-new-line)
...
[**`padBoth`**](https://laravel.com/docs/11.x/strings#method-fluent-str-padboth)
...
[**`padLeft`**](https://laravel.com/docs/11.x/strings#method-fluent-str-padleft)
...
[**`padRight`**](https://laravel.com/docs/11.x/strings#method-fluent-str-padright)
...
[**`pipe`**](https://laravel.com/docs/11.x/strings#method-fluent-str-pipe)
...
[**`plural`**](https://laravel.com/docs/11.x/strings#method-fluent-str-plural)

The `plural` method converts a singular word string to its plural form. This function supports [any of the languages support by Laravel's pluralizer](https://laravel.com/docs/11.x/localization#pluralization-language):
...
[**`position`**](https://laravel.com/docs/11.x/strings#method-fluent-str-position)
...
[**`prepend`**](https://laravel.com/docs/11.x/strings#method-fluent-str-prepend)
...
[**`remove`**](https://laravel.com/docs/11.x/strings#method-fluent-str-remove)
...
[**`repeat`**](https://laravel.com/docs/11.x/strings#method-fluent-str-repeat)
...
[**`replace`**](https://laravel.com/docs/11.x/strings#method-fluent-str-replace)
...
[**`replaceArray`**](https://laravel.com/docs/11.x/strings#method-fluent-str-replace-array)
...
[**`replaceFirst`**](https://laravel.com/docs/11.x/strings#method-fluent-str-replace-first)
...
[**`replaceLast`**](https://laravel.com/docs/11.x/strings#method-fluent-str-replace-last)
...
[**`replaceMatches`**](https://laravel.com/docs/11.x/strings#method-fluent-str-replace-matches)
...
[**`replaceStart`**](https://laravel.com/docs/11.x/strings#method-fluent-str-replace-start)
...
[**`replaceEnd`**](https://laravel.com/docs/11.x/strings#method-fluent-str-replace-end)
...
[**`scan`**](https://laravel.com/docs/11.x/strings#method-fluent-str-scan)
...
[**`singular`**](https://laravel.com/docs/11.x/strings#method-fluent-str-singular)

The `singular` method converts a string to its singular form. This function supports [any of the languages support by Laravel's pluralizer](https://laravel.com/docs/11.x/localization#pluralization-language):

```
use Illuminate\Support\Str; $singular = Str::of('cars')->singular(); // car $singular = Str::of('children')->singular(); // child
```

[**`slug`**](https://laravel.com/docs/11.x/strings#method-fluent-str-slug)
...
[**`snake`**](https://laravel.com/docs/11.x/strings#method-fluent-str-snake)
...
[**`split`**](https://laravel.com/docs/11.x/strings#method-fluent-str-split)
...
[**`squish`**](https://laravel.com/docs/11.x/strings#method-fluent-str-squish)
...
[**`start`**](https://laravel.com/docs/11.x/strings#method-fluent-str-start)
...
[**`startsWith`**](https://laravel.com/docs/11.x/strings#method-fluent-str-starts-with)
...
[**`stripTags`**](https://laravel.com/docs/11.x/strings#method-fluent-str-strip-tags)
...
[**`studly`**](https://laravel.com/docs/11.x/strings#method-fluent-str-studly)
...
[**`substr`**](https://laravel.com/docs/11.x/strings#method-fluent-str-substr)
...
[**`substrReplace`**](https://laravel.com/docs/11.x/strings#method-fluent-str-substrreplace)
...
[**`swap`**](https://laravel.com/docs/11.x/strings#method-fluent-str-swap)
...
[**`take`**](https://laravel.com/docs/11.x/strings#method-fluent-str-take)
...
[**`tap`**](https://laravel.com/docs/11.x/strings#method-fluent-str-tap)
...
[**`test`**](https://laravel.com/docs/11.x/strings#method-fluent-str-test)
...
[**`title`**](https://laravel.com/docs/11.x/strings#method-fluent-str-title)
...
[**`toBase64`**](https://laravel.com/docs/11.x/strings#method-fluent-str-to-base64)
...
[**`toHtmlString`**](https://laravel.com/docs/11.x/strings#method-fluent-str-to-html-string)
...
[**`transliterate`**](https://laravel.com/docs/11.x/strings#method-fluent-str-transliterate)
...
[**`trim`**](https://laravel.com/docs/11.x/strings#method-fluent-str-trim)
...
[**`ltrim`**](https://laravel.com/docs/11.x/strings#method-fluent-str-ltrim)
...
[**`rtrim`**](https://laravel.com/docs/11.x/strings#method-fluent-str-rtrim)
...
[**`ucfirst`**](https://laravel.com/docs/11.x/strings#method-fluent-str-ucfirst)
...
[**`ucsplit`**](https://laravel.com/docs/11.x/strings#method-fluent-str-ucsplit)
...
[**`unwrap`**](https://laravel.com/docs/11.x/strings#method-fluent-str-unwrap)
...
[**`upper`**](https://laravel.com/docs/11.x/strings#method-fluent-str-upper)
...
[**`when`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when)
...
[**`whenContains`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-contains)
...
[**`whenContainsAll`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-contains-all)
...
[**`whenEmpty`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-empty)
...
[**`whenNotEmpty`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-not-empty)
...
[**`whenStartsWith`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-starts-with)
...
[**`whenEndsWith`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-ends-with)
...
[**`whenExactly`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-exactly)
...
[**`whenNotExactly`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-not-exactly)
...
[**`whenIs`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-is)
...
[**`whenIsAscii`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-is-ascii)
...
[**`whenIsUlid`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-is-ulid)
...
[**`whenIsUuid`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-is-uuid)
...
[**`whenTest`**](https://laravel.com/docs/11.x/strings#method-fluent-str-when-test)
...
[**`wordCount`**](https://laravel.com/docs/11.x/strings#method-fluent-str-word-count)
...
[**`words`**](https://laravel.com/docs/11.x/strings#method-fluent-str-words)
...
[**`wrap`**](https://laravel.com/docs/11.x/strings#method-fluent-str-wrap)
