...
<a name="introduction" id="introduction" href="introduction"></a>
...
<a name="driver-prerequisites" id="driver-prerequisites" href="driver-prerequisites"></a>

### [Driver Prerequisites](cache.md#driver-prerequisites)

<a name="prerequisites-database" id="prerequisites-database" href="prerequisites-database"></a>

#### [Database](cache.md#prerequisites-database)
...
<a name="memcached" id="memcached" href="memcached"></a>

#### [Memcached](cache.md#memcached)

Using the Memcached driver requires the [Memcached PECL package](https://pecl.php.net/package/memcached) to be installed. You may list all of your Memcached servers in the `app/etc/env.php.php` configuration file. This file already contains a `memcached.servers` entry to get you started:
...
<a name="redis" id="redis" href="redis"></a>
...
<a name="dynamodb" id="dynamodb" href="dynamodb"></a>
...
<a name="mongodb" id="mongodb" href="mongodb"></a>
...
<a name="cache-usage" id="cache-usage" href="cache-usage"></a>
...
<a name="accessing-multiple-cache-stores" id="accessing-multiple-cache-stores" href="accessing-multiple-cache-stores"></a>
...
<a name="determining-item-existence" id="determining-item-existence" href="determining-item-existence"></a>
...
<a name="incrementing-decrementing-values" id="incrementing-decrementing-values" href="incrementing-decrementing-values"></a>
...
<a name="retrieve-store" id="retrieve-store" href="retrieve-store"></a>
...
<a name="retrieve-delete" id="retrieve-delete" href="retrieve-delete"></a>
...
<a name="store-if-not-present" id="store-if-not-present" href="store-if-not-present"></a>
...
<a name="storing-items-forever" id="storing-items-forever" href="storing-items-forever"></a>
...
<a name="atomic-locks" id="atomic-locks" href="atomic-locks"></a>
...
<a name="adding-custom-cache-drivers" id="adding-custom-cache-drivers" href="adding-custom-cache-drivers"></a>

## [Adding Custom Cache Drivers](cache.md#adding-custom-cache-drivers)

<a name="writing-the-driver" id="writing-the-driver" href="writing-the-driver"></a>
...
<a name="registering-the-driver" id="registering-the-driver" href="registering-the-driver"></a>
...
The first argument passed to the `extend` method is the name of the driver. This will correspond to your `driver` option in the `app/etc/env.php.php` configuration file. The second argument is a closure that should return an `Illuminate\Cache\Repository` instance. The closure will be passed an `$app` instance, which is an instance of the [service container](/docs/{{version}}/container).

Once your extension is registered, update the `CACHE_STORE` environment variable or `default` option within your application's `app/etc/env.php.php` configuration file to the name of your extension.

<a name="events" id="events" href="events"></a>
